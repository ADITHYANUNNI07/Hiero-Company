...
class SignUpProviderModel with ChangeNotifier {
  ...
  String _selectedJobOrIntern = 'Job'; // Ensure this matches one of the items

  String get selectedJobOrIntern => _selectedJobOrIntern;

  void setSelectedJobOrIntern(String jobOrIntern) {
    _selectedJobOrIntern = jobOrIntern;
    notifyListeners();
  }
